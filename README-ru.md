...
> [!IMPORTANT]
> Данный раздел следует изучать администраторам **только**, если у вас уже были заведены пользователи в TrueConf Server.
> Перед выполнением шагов следуйте инструкции из раздела [Автоматический сбор пользователей](#автоматический-сбор-пользователей).
